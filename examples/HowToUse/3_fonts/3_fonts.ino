...
void setup(void)
{
  ...
  // 文字の表示方法には大きく分けて２通り、print 系の関数と drawString 系の関数があります。
  ...
  // printf関数で、第２引数以降の内容を表示できます。(C言語のprintf準拠ですので文字列や浮動小数も表示できます)
  int value = 123;
  ...
  // 第１引数が行末での折り返し、第２引数で画面下端で上端への折り返しを指定します。
  // 第２引数は省略時 false として扱われます。
