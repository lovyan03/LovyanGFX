...
ESP_LOGI("test", "BTN_A");
    ...
    case  1: tft.loadFont("/Ud36.vlw", SD); break;
    case  2: tft.loadFont("/SourceHanSans-Normal10.vlw", SD); break;
    case  3: tft.loadFont("/SourceHanSans-Normal12.vlw", SD); break;
    case  4: tft.loadFont("/SourceHanSans-Normal16.vlw", SD); break;

//    case  1: tft.setTextFont(2); break;
//    case  2: tft.setTextFont(4); break;
//    case  3: tft.setTextFont(6); break;
//    case  4: tft.setTextFont(7); break;
    case  6: tft.loadFont(Ud_36); break;
...
void setup(void) {
  lgfx::initGPIO(BUTTON_A_PIN, GPIO_MODE_INPUT, true);
  lgfx::initGPIO(BUTTON_B_PIN, GPIO_MODE_INPUT, true);
  lgfx::initGPIO(BUTTON_C_PIN, GPIO_MODE_INPUT, true);
