...
static lgfx::LGFX_Offscreen tft(&tft_lcd);
...
void setup() {
  ...
  //tft.setColorDepth( 2);  tft.createSprite(240,320);
  //tft.setColorDepth( 4);  tft.createSprite(240,320);
  ...
  tft.setColorDepth(8);
  if (!tft.createSprite(240,240)) {
    Serial.println(F("Sprite create failure.")); 
    for (;;) delay(10);
  }
