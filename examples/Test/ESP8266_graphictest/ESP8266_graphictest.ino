...
#define LOLIN_SHIELD
  ...
  // settings for TFT 1.4 (Wemos Shield) /w ESP8266
  #define TFT_MISO    D6
  #define TFT_CS      D4
  #define TFT_MOSI    D7
  #define TFT_SCK     D5
  ...
  #define SPI_FREQ_W 39000000
  #define SPI_FREQ_R 16000000
  ...
  class LGFX : public lgfx::LGFX_Device
  {
   ...
   public:
    ...
    const char* driver_name = "ST7735S 1.4''";
...
#ifdef LOLIN_SHIELD
  // settings for TFT-2.4 (LoLin Shield) /w ESP8266
  #define TFT_MISO    D6
  #define TFT_CS      D0
  #define TFT_MOSI    D7
  #define TFT_SCK     D5
...
void setup() {
  ...
  #if defined WEMOS_SHIELD && SPI_FREQ_W >= 40000000
    // ST7735 40MHz overclocking tradeoff: vscroll init setting need to be replayed
    tft.startWrite();
