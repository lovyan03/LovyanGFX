...
namespace lgfx {
  ...
  __attribute__ ((always_inline)) inline static uint8_t u8sr5(uint8_t s) { return s>>5; }
  __attribute__ ((always_inline)) inline static uint8_t u8sl5(uint8_t s) { return s<<5; }

  inline static uint8_t  color332(uint8_t r, uint8_t g, uint8_t b) { return (r & 0xE0) | ((g & 0xE0) >> 3) | (b >> 6); }
  inline static uint16_t color565(uint8_t r, uint8_t g, uint8_t b) { return ((r>>3)<<11) | ((g>>2)<<5) | (b>>3); }
  inline static uint32_t color888(uint8_t r, uint8_t g, uint8_t b) { return (r << 16) | (g << 8) | b; }
  inline static uint16_t swap565( uint8_t r, uint8_t g, uint8_t b) { return ((b >> 3) << 8) | ((g >> 2) << 13) | ((g >> 5) | ((r>>3)<<3)); }
...
//inline uint16_t convert_rgb332_to_rgb565( uint8_t c) { return (((c&0xE0)*0x120)&0xF800) | ((c&0x1C)*0x48) | (((c&3)*0x15)>>1); }
  ...
  inline uint32_t convert_rgb888_to_rgb332( uint32_t c) { return ((c>>16) & 0xE0) | ((c>>11) & 0x1C) | ((c>>6) & 3); }
  inline uint32_t convert_rgb888_to_mono1b( uint32_t c) { return c?~0:0; }

//  inline uint32_t convert_rgb565_to_swap888(uint16_t c) { return ((((c&0x1F)*0x21)>>2)<<8 | ((((c>>5)&0x3F)*0x41)>>4))<<8 | (((c>>11)*0x21)>>2); }
  inline uint32_t convert_rgb565_to_swap888(uint16_t c) { return ((((c&0x1F)*0x21)>>2)<<8 | ((((c&0x7E0)>>5)*0x41)>>4))<<8 | (((c>>11)*0x21)>>2); }
  ...
  inline uint32_t convert_rgb565_to_rgb332( uint16_t c) { return ((c>>8) & 0xE0) | ((c>>6) & 0x1C) | ((c>>3) & 3); }
  inline uint32_t convert_rgb565_to_mono1b( uint16_t c) { return c?~0:0; }
  ...
  inline uint32_t convert_rgb332_to_mono1b( uint8_t c) { return c?~0:0; }
...
#pragma pack(1)
  ...
  struct mono1_t {
    ...
    mono1_t() : raw(0) {}
    mono1_t(const mono1_t&) = default;
    mono1_t(uint8_t c) : raw(c) {}
  };
...
//  swap666_t(uint32_t color888) : r(color888), g(color888>>8), b(color888>>16) {}
  ...
  struct dev_color_t {
    ...
    void setColorDepth(color_depth_t bpp) {
      if (     bpp > 18) bpp = rgb888_3Byte;
      else if (bpp > 16) bpp = rgb666_3Byte;
      else if (bpp >  8) bpp = rgb565_2Byte;
      else if (bpp >  1) bpp = rgb332_1Byte;
      else               bpp = mono_1bit;
      this->bpp = bpp;
      bytes = (bpp == rgb666_3Byte) ? 3 : (bpp >> 3);
      switch (bpp) {
      case rgb888_3Byte:
      ...
      case rgb332_1Byte:
        ...
        break;
      case mono_1bit:
        convert_rgb888 = convert_rgb888_to_mono1b;
        convert_rgb565 = convert_rgb565_to_mono1b;
        convert_rgb332 = convert_rgb332_to_mono1b;
        break;
      }
    }
