...
#error "Panel_NV3041A.inl is part of lgfx_v1.cpp and is not meant to be included on its own"
#endif
...
namespace lgfx
{
    inline namespace v1
    {
        // C++11/14: a static constexpr data member that is odr-used (its address is taken)
        // needs a definition outside the class.
