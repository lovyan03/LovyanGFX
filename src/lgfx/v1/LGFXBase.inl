...
// lgfx_qrcode.h defines generic macro names (MODE_*, ECC_*, LOCK_VERSION). Drop them here so they
// cannot rewrite headers included later in this translation unit (OpenCV's objdetect.hpp uses the same names).
#undef MODE_NUMERIC
