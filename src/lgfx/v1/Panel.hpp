...
//----------------------------------------------------------------------------
  ...
  public:
    ...
    virtual void init(bool use_reset = true) = 0;
    ...
    virtual void setIdol(bool flg_partial) = 0;
    ...
    virtual std::uint32_t readPanelID(void) = 0;
  ...
  struct Panel_NULL : public IPanel
  {
    ...
    void setIdol(bool flg_partial) override {}
    ...
    std::uint32_t readPanelID(void) override { return 0; }
