...
#error "Panel_fb.inl is part of lgfx_v1.cpp and is not meant to be included on its own"
#endif
#include "../common.hpp"   // selects the platform (defines LGFX_PLATFORM_*)
#if defined ( LGFX_PLATFORM_FRAMEBUFFER )
