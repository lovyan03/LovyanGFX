...
#error "Bus_HUB75.inl is part of lgfx_v1.cpp and is not meant to be included on its own"
#endif
...
//----------------------------------------------------------------------------
  ...
  static constexpr uint32_t _conf_reg_default_hub75 = I2S_TX_MSB_RIGHT | I2S_TX_RIGHT_FIRST | I2S_RX_RIGHT_FIRST | I2S_TX_MONO;
  static constexpr uint32_t _conf_reg_start_hub75   = _conf_reg_default_hub75 | I2S_TX_START;
  static constexpr uint32_t _conf_reg_reset_hub75   = _conf_reg_default_hub75 | I2S_TX_RESET;
  static constexpr uint32_t _sample_rate_conf_reg_direct_hub75 = 16 << I2S_TX_BITS_MOD_S | 16 << I2S_RX_BITS_MOD_S | 1 << I2S_TX_BCK_DIV_NUM_S | 1 << I2S_RX_BCK_DIV_NUM_S;
  static constexpr uint32_t _fifo_conf_default_hub75 = 1 << I2S_TX_FIFO_MOD | 1 << I2S_RX_FIFO_MOD | 16 << I2S_TX_DATA_NUM_S | 16 << I2S_RX_DATA_NUM_S;
  static constexpr uint32_t _fifo_conf_dma_hub75     = _fifo_conf_default_hub75 | I2S_DSCR_EN;


  __attribute__((always_inline))
  static inline i2s_dev_t* getDev_hub75(i2s_port_t port)
  {
#if SOC_I2C_NUM > 1
  ...
  {
    _cfg = cfg;
    _dev = getDev_hub75(cfg.i2s_port);
  }
  ...
  bool Bus_HUB75::init(void)
  {
    ...
    i2s_dev->conf.val = _conf_reg_default_hub75;
...
//*/
    ...
    auto i2s_dev = (i2s_dev_t*)_dev;
    i2s_dev->out_link.val = 0;
    i2s_dev->fifo_conf.val = _fifo_conf_dma_hub75;
    i2s_dev->sample_rate_conf.val = _sample_rate_conf_reg_direct_hub75;

    i2s_dev->clkm_conf.val = getClockDivValue(_cfg.freq_write);
    i2s_dev->conf.val = _conf_reg_reset_hub75;
  ...
  void IRAM_ATTR Bus_HUB75::i2s_intr_handler_hub75(void *arg)
  {
    ...
    auto dev = getDev_hub75(me->_cfg.i2s_port);
...
//*/
  ...
  void Bus_HUB75::dmaTask(void *arg)
  {
    ...
    auto dev = getDev_hub75(me->_cfg.i2s_port);
    dev->conf.val = _conf_reg_start_hub75;
    dev->int_clr.val = ~0u;
