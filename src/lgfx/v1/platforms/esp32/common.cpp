...
//----------------------------------------------------------------------------
  ...
  namespace qspi
  {
    ...
    cpp::result<void, error_t> init(int spi_host, int spi_sclk, int spi_io0, int spi_io1, int spi_io2, int spi_io3)
    {
      return init(spi_host, spi_sclk, spi_io0, spi_io1, spi_io2, spi_io3, 0); // SPI_DMA_CH_AUTO;
    }
