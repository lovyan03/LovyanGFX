...
#error "Panel_LT8912B.inl is part of lgfx_v1.cpp and is not meant to be included on its own"
#endif
...
// Keep the compatibility macro above out of the files that follow in the shared translation unit.
