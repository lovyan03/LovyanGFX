...
//----------------------------------------------------------------------------
  ...
  void LGFXBase::panel(IPanel* panel)
  {
    _panel = panel;
    //static Panel_NULL nullobj;
    //_panel = panel ? panel : &nullobj;
  }
  void LGFXBase::init_impl(bool use_reset)
  {
    if (!_panel) return;
...
//----------------------------------------------------------------------------
  ...
  void LGFX_Device::init_impl(bool use_reset)
  {
    LovyanGFX::init_impl(use_reset);
